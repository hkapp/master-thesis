...
We start once again with the UDF case. We wrote a set of very small, UDF-like programs, calling the \varchar{} builtins we implemented. Results for these benchmarks is shown in Figure \ref{fig:exp3a}. 
