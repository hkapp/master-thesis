...
\begin{figure}[t]
	\centering
	\makebox[\textwidth]{\includegraphics[width=15cm]{./graphs/VisualExample.png}}
...
%We will focus on two abstract concepts, both used as part of an SQL query. The first workload considered is User-Defined Functions (UDFs), which are very short functions, performing only a few operations. The second will be closer to Stored Procedures use (STP), with longer-running program, using loops. 
...
\begin{figure}[tp]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=16cm]{./results/exp1a.png}}
...
%Although not interesting in itself because it does not show performance for a typical use of PL/SQL, this experiment will be useful in determining the actual speedup that comes from executing PL/SQL code with our alternative.
...
\begin{figure}[tp]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=16cm]{./results/exp2a.png}}
...
\begin{figure}[tp]
	\centering
	\makebox[\textwidth][c]{\includegraphics[scale=1]{./results/exp2b.png}}
...
\begin{figure}[tp]
	\centering
	\makebox[\textwidth][c]{\includegraphics[scale=1]{./results/exp3a.png}}
...
\begin{figure}[tp]
	\centering
	\makebox[\textwidth][c]{\includegraphics[scale=1]{./results/exp3b.png}}
...
\begin{figure}[tp]
	\centering
	\makebox[\textwidth][c]{\includegraphics[scale=1]{./results/exp3c.png}}
...
\item[\bench{search}] Simple \pls{CASE} expression with 6 branches, conditioned on the input values
\end{itemize}
