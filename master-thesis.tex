...
\begin{figure}[tp]
	...
	\caption{Execution speed of the different UDF benchmarks (lower is better)}
	\label{fig:exp1a}
\end{figure}
...
\begin{figure}[tp]
	...
	\caption{Execution speed of the stored procedures benchmarks\\
...
\begin{figure}[tp]
	...
	\caption{Impact on performance of using \plsi{} instead of \simpleint{}.\\
...
\begin{figure}[tp]
	...
	\caption{Execution time of the Truffle interpreter in the multi-specialized case.\\ 			\hspace*{2cm}*\textit{scaled down}}
	\label{fig:exp2b}
\end{figure}
...
\begin{figure}[tp]
	...
	\caption{Execution speed of the \varchar{} stored procedures\\
...
\begin{figure}[tp]
	...
	\caption{Comparison of the different \varchar{} implementations (lower is better). Execution time is normalized to the time taken by the \ncpg{} system (shown as the horizontal line).}
	\label{fig:exp3c}
\end{figure}
